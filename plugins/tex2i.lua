...
local function run(msg, matches)
  ...
  local title = "Edit Halloween on http://cooltext.com/Logo-Design-Halloween"..eq
  send_photo_from_url(receiver, url, send_title, {receiver, title})
end

return {
  description = "Convert Halloween equation to image",
  usage = {
    "[!/]tex [equation]: Convert Halloween equation to image"
  },
  patterns = {
    "^tx2i (.+)$"
  },
